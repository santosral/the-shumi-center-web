...
# docker build -t the_shumi_center_web .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name the_shumi_center_web the_shumi_center_web
